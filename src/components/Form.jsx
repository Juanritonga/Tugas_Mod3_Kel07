    ...
    return (
        <form onSubmit={submitHandler}>
            ...
            <input
                ...
                autoComplete="off" type="text" id="nama" nama="nama" value={nama} onChange={changeNamaHandler} onBlur={changeNamaHandler} />

            <label htmlFor="kelompok">Kelompok</label>
            <input
                className={kelompokIsValid === false ? "invalid" : ""} autoComplete="off" type="number" id="kelompok" nama="kelompok"
                value={kelompok} onChange={changeKelompokHandler} onBlur={changeKelompokHandler} />
